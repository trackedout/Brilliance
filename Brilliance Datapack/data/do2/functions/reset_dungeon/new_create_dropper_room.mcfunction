...
setblock -463 115 1979 oak_sign[rotation=8]{front_text:{messages:['{"text":"Crown Shop","color":"#FFEB64"}','{"text":"","color":"#FFEB64"}','{"text":"product for sale","color":"#FFEB64"}','{"text":"#13_p2","color":"#00FFFF","bold":true,"clickEvent":{"action":"run_command","value":"/execute positioned -493 102 1972 as @s if entity @s[tag=dropper_teleporting_allowed] run tp @s ~ ~ ~"}}']},is_waxed:1b} replace
