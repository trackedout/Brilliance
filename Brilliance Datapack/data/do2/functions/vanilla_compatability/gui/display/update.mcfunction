...
execute unless score #current do2.utility.gui = #previous do2.utility.gui run function do2:vanilla_compatability/gui/display/update_embers
...
execute unless score #current do2.utility.gui = #previous do2.utility.gui run function do2:vanilla_compatability/gui/display/update_treasure
...
execute unless score #current do2.utility.gui = #previous do2.utility.gui run function do2:vanilla_compatability/gui/display/update_hazard_block
...
execute unless score #current do2.utility.gui = #previous do2.utility.gui run function do2:vanilla_compatability/gui/display/update_clank_block
...
execute unless score #current do2.utility.gui = #previous do2.utility.gui run function do2:vanilla_compatability/gui/display/update_cards
