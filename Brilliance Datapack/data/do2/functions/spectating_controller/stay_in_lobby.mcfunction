...
# Need to check if is inside at least ONE bounding box. Best way I could do this:
...
execute if score @s do2.tests.playerInLocation matches 0 run tellraw @s {"text":"Unable to leave lobby as a spectator.","color":"red"}
