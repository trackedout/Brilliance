...
execute if entity @a[tag=do2.inStatsRoom] positioned -498 126 1995 run playsound minecraft:item.lodestone_compass.lock block @a[distance=..10] -498 126 1995 2 0.5 1
