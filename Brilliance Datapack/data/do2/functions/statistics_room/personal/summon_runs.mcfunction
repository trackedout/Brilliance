...
execute unless score @p do2.systems.clank.generated matches 0.. run scoreboard players set @p do2.systems.clank.generated 0
execute unless score @p do2.systems.hazard.blocked matches 0.. run scoreboard players set @p do2.systems.hazard.blocked 0
execute unless score @p do2.systems.clank.blocked matches 0.. run scoreboard players set @p do2.systems.clank.blocked 0


execute unless entity @e[tag=do2.statistics_room,tag=do2.stats.runs] run summon minecraft:text_display -492 125 1990 {Rotation:[90f,0f], billboard:"fixed",background:26,Tags:["do2.statistics_room","do2.stats.runs"]}
