...
execute as @e[tag=do2.statistics_room,tag=do2.stats.spoilers] if entity @s run data merge entity @s {text:'[{"text":"§l§dSpoilers §fStatistics!§r\\n"},{"text":"\\n"},{"storage": "stats_display","nbt": "bombsPickedUp_name"},{"score":{"name":"@p","objective":"do2.run.active"},"color":"red","italic":true},{"text":"\\n"},{"storage": "stats_display","nbt": "bombsSubmitted_name"},{"score":{"name":"@p","objective":"do2.run.active"},"color":"red","italic":true},{"text":"\\n"},{"storage": "stats_display","nbt": "keysSubmitted_name"},{"score":{"name":"@p","objective":"do2.run.active"},"color":"red","italic":true},{"text":"\\n"},{"storage": "stats_display","nbt": "tntDepthDives_name"},{"score":{"name":"@p","objective":"do2.depth_charge_success"},"color":"aqua","italic":true},{"text":"\\n"},{"storage": "stats_display","nbt": "rustyRepairs_name"},{"score":{"name":"@p","objective":"do2.run.active"},"color":"red","italic":true},{"text":"\\n"},{"storage": "stats_display","nbt": "tendrilsFound_name"},{"score":{"name":"@p","objective":"do2.run.active"},"color":"red","italic":true}]'}
