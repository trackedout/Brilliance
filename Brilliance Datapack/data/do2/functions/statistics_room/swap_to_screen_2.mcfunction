...
execute if entity @a[tag=do2.inStatsRoom] positioned -494 125 1986 run playsound minecraft:block.amethyst_cluster.hit block @a[distance=..10] -494 125 1986 2 1.5 1
