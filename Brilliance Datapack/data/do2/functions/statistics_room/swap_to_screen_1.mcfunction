...
execute if entity @a[tag=do2.inStatsRoom] positioned -496 125 1986 run playsound minecraft:entity.player.levelup block @a[distance=..10] -496 125 1986 2 1.5 1
