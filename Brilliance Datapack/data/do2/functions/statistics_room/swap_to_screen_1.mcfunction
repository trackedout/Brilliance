...
execute unless entity @a[x=-507,dx=16,y=118,dy=10,z=1986,dz=10] positioned -496 125 1986 run playsound minecraft:entity.player.levelup block @a[distance=..10] -496 125 1986 2 1.5 1
