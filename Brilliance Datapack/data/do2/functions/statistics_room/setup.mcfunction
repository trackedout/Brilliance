...
data merge block -494 125 1986 {front_text:{has_glowing_text:1b,color:"white",is_waxed:1b,messages:['{"text":""}','{"text":"View §2Runs","color":""}','{"text":"Statistics","color":""}','{"text":"","color":"","clickEvent":{"action":"run_command","value":"/function do2:statistics_room/swap_to_screen_2"}}']},is_waxed:1b}
...
data merge block -494 125 1994 {front_text:{has_glowing_text:1b,color:"white",is_waxed:1b,messages:['{"text":""}','{"text":"View §d§lSPOILERS","color":""}','{"text":"Statistics","color":""}','{"text":"","color":"","clickEvent":{"action":"run_command","value":"/function do2:statistics_room/swap_to_screen_5"}}']},is_waxed:1b}
