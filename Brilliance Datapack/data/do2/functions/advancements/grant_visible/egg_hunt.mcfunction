...
execute as @s[advancements={do2:visible/adventuring/egg_hunt/level_1/1st_level_show=false,do2:hidden/adventuring/egg_hunt/level_1/1st_level_show=true}] run advancement grant @s only do2:visible/adventuring/egg_hunt/level_1/1st_level_show
# Level 2
...
execute as @s[advancements={do2:visible/adventuring/egg_hunt/level_2/2nd_level_show=false,do2:hidden/adventuring/egg_hunt/level_2/2nd_level_show=true}] run advancement grant @s only do2:visible/adventuring/egg_hunt/level_2/2nd_level_show
# Level 3
...
execute as @s[advancements={do2:visible/adventuring/egg_hunt/level_3/zz_tango=false,do2:hidden/adventuring/egg_hunt/level_3/zz_tango=true}] run advancement grant @s only do2:visible/adventuring/egg_hunt/level_3/zz_tango
...
execute as @s[advancements={do2:visible/adventuring/egg_hunt/level_3/3rd_level_show=false,do2:hidden/adventuring/egg_hunt/level_3/3rd_level_show=true}] run advancement grant @s only do2:visible/adventuring/egg_hunt/level_3/3rd_level_show
