...
execute unless score @s do2.eggs.grian matches 1.. run scoreboard players set @s do2.eggs.grian 1
...
# Agronet event
function do2:external/agronet/logs/player_actions/egg_hunt/grian