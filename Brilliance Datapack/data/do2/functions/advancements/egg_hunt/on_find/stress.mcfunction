...
execute unless score @s do2.eggs.stress matches 1.. run scoreboard players set @s do2.eggs.stress 1
...
execute if score $dungeon do2.config.eggRewards matches 1 run data modify block -553 49 2027 Items set value [{Slot: 13b, id: "minecraft:iron_nugget", Count: 5b, tag: { CustomModelData: 2, tracked:0b, display: {Name: '{"text":"❄☠ Decked Out Crown ☠❄"}'}}}]
execute if score $dungeon do2.config.eggRewards matches 2 run data modify block -553 49 2027 Items set value [{Slot: 13b, id: "minecraft:iron_nugget", Count: 5b, tag: { CustomModelData: 2, tracked:0b, display: {Name: '{"text":"❄☠ Decked Out Crown ☠❄"}'}}}]
execute if score $dungeon do2.config.eggRewards matches 3 run data modify block -553 49 2027 Items set value [{Slot: 13b, id: "minecraft:iron_nugget", Count: 1b, tag: { CustomModelData: 2, tracked:0b, display: {Name: '{"text":"❄☠ Decked Out Crown ☠❄"}'}}}]

playsound minecraft:block.barrel.open master @s -553 49 2027
scoreboard players set @s do2.eggs.stress 2

# Agronet event
function do2:external/agronet/logs/player_actions/egg_hunt/stress