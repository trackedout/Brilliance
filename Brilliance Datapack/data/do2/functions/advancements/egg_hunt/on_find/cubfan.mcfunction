...
execute unless score @s do2.eggs.cub matches 1.. run scoreboard players set @s do2.eggs.cub 1
...
execute if score $dungeon do2.config.eggRewards matches 1 run data modify block -508 18 1969 Items set value [{Slot: 13b, id: "minecraft:iron_nugget", Count: 10b, tag: { CustomModelData: 2, tracked:0b, display: {Name: '{"text":"❄☠ Decked Out Crown ☠❄"}'}}}]
execute if score $dungeon do2.config.eggRewards matches 2 run data modify block -508 18 1969 Items set value [{Slot: 13b, id: "minecraft:iron_nugget", Count: 10b, tag: { CustomModelData: 2, tracked:0b, display: {Name: '{"text":"❄☠ Decked Out Crown ☠❄"}'}}}]
execute if score $dungeon do2.config.eggRewards matches 3 run data modify block -508 18 1969 Items set value [{Slot: 13b, id: "minecraft:iron_nugget", Count: 2b, tag: { CustomModelData: 2, tracked:0b, display: {Name: '{"text":"❄☠ Decked Out Crown ☠❄"}'}}}]

playsound minecraft:block.barrel.open master @s -508 18 1969
scoreboard players set @s do2.eggs.cub 2

# Agronet event
function do2:external/agronet/logs/player_actions/egg_hunt/cubfan