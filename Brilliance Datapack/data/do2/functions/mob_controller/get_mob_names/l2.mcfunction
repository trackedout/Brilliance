# - WITH ZONES -
execute if score $dungeon do2.config.mc.level2Zones matches 1 positioned -526 123 1945 run function do2:mob_controller/get_mob_names/get_names_from_shulker
...
execute if score $dungeon do2.config.mc.level2Zones matches 1 positioned -526 123 1944 run function do2:mob_controller/get_mob_names/get_names_from_shulker
...
execute if score $dungeon do2.config.mc.level2Zones matches 1 positioned -526 123 1943 run function do2:mob_controller/get_mob_names/get_names_from_shulker
...
# - WITHOUT ZONES -
execute if score $dungeon do2.config.mc.level2Zones matches 0 positioned -526 126 1946 run function do2:mob_controller/get_mob_names/get_names_from_shulker
...
execute if score $dungeon do2.config.mc.level2Zones matches 0 positioned -526 126 1945 run function do2:mob_controller/get_mob_names/get_names_from_shulker
...
execute if score $dungeon do2.config.mc.level2Zones matches 0 positioned -526 126 1944 run function do2:mob_controller/get_mob_names/get_names_from_shulker
...
execute if score $dungeon do2.config.mc.level2Zones matches 0 positioned -526 126 1943 run function do2:mob_controller/get_mob_names/get_names_from_shulker
...
execute if score $dungeon do2.config.mc.level2Zones matches 0 positioned -526 126 1942 run function do2:mob_controller/get_mob_names/get_names_from_shulker
