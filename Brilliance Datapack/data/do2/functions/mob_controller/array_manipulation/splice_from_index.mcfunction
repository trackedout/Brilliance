...
execute if score $dungeon do2.tests.arrayIndex matches 1.. run function do2:mob_controller/array_manipulation/splice_from_index
...
execute if score $dungeon do2.tests.arrayIndex matches ..0 run function do2:mob_controller/array_manipulation/splice_from_index_helper
# exit loop
