...
# Warden Names
data merge block -529 115 1945 {Items:[{Slot:0b, id:"minecraft:carved_pumpkin", Count:1b, tag:{CustomModelData:91,display:{Name:'{"text":"Pain"}'}}}]}
data merge block -529 115 1944 {Items:[{Slot:0b, id:"minecraft:carved_pumpkin", Count:1b, tag:{CustomModelData:91,display:{Name:'{"text":"Panic"}'}}}]}
data merge block -529 115 1943 {Items:[{Slot:0b, id:"minecraft:carved_pumpkin", Count:1b, tag:{CustomModelData:91,display:{Name:'{"text":"Pancakes"}'}}}]}
