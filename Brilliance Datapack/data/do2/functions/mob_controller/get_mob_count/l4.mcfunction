# - WITH ZONES -
execute if score $dungeon do2.config.mc.level4Zones matches 1 positioned -521 122 1945 run function do2:mob_controller/get_mob_count/count_inside_barrel
...
execute if score $dungeon do2.config.mc.level4Zones matches 1 positioned -521 122 1944 run function do2:mob_controller/get_mob_count/count_inside_barrel
...
execute if score $dungeon do2.config.mc.level4Zones matches 1 positioned -521 122 1943 run function do2:mob_controller/get_mob_count/count_inside_barrel
...
# - WITHOUT ZONES -
execute if score $dungeon do2.config.mc.level4Zones matches 0 positioned -521 125 1945 run function do2:mob_controller/get_mob_count/count_inside_barrel
...
execute if score $dungeon do2.config.mc.level4Zones matches 0 positioned -521 125 1944 run function do2:mob_controller/get_mob_count/count_inside_barrel
...
execute if score $dungeon do2.config.mc.level4Zones matches 0 positioned -521 125 1943 run function do2:mob_controller/get_mob_count/count_inside_barrel
