...
execute if score $dungeon do2.utility.mc.mobNamesCount < $l2willy do2.config.mc.levelZoneMobCount run function do2:mob_controller/add_mob_names/drowned_names
