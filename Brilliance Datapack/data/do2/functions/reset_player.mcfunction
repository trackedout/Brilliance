...
execute if score $dungeon do2.config.forceGamemode matches 1 if entity @s[team=!do2.spectators,scores={do2.utility.deathCount=0}] unless entity @s[tag=do2.staff] run tp @s -550 113 1982
