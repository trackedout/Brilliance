...
execute as @p[tag=do2.received_shulker] run scoreboard players operation @s do2.lifetime.spent.crowns += $dungeon do2.cards.price.DUL
scoreboard players operation $dungeon do2.lifetime.spent.crowns += $dungeon do2.cards.price.DUL

# Agronet Event Handling
scoreboard players set $dungeon do2.agronet.card_bought undefined
