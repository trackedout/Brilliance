...
execute as @p[tag=do2.received_shulker] run scoreboard players add @s do2.cards.available.SNE 1
scoreboard players set $dungeon do2.run.cards.available.SNE 1

scoreboard players add $dungeon do2.cards.available.SNE 1
