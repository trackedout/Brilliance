#  - Start Log -
execute as @a[scores={do2.logs.cards=1..}] run tellraw @s ["",{"text":"§f[§9B§r]: Card Bought: ("},{"text":"§aQuick Step","hoverEvent":{"action":"show_item","value":"{id:'minecraft:iron_nugget', Count:1, tag:{NameFormat:{color:\"#80c71f\",OriginalName:'{\"color\":\"#80C71F\",\"text\":\"✧ Quickstep ✧\"}',ModifiedName:'{\"color\":\"#80C71F\",\"text\":\"✧ Quickstep ✧\"}'},CustomModelData:121,CustomRoleplayData:1b,display:{Name:'{\"color\":\"#80C71F\",\"text\":\"✧ Quickstep ✧\"}'}}}"}},{"text":")"}]
# - End Log -
