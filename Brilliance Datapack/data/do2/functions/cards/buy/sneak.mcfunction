#  - Start Log -
execute as @a[scores={do2.logs.cards=1..}] run tellraw @s ["",{"text":"[§9B§r]: Card Bought: ("},{"text":"§aSneak","hoverEvent":{"action":"show_item","value":"{id:'minecraft:iron_nugget', Count:1, tag:{NameFormat:{color:\"gray\",OriginalName:'{\"color\":\"gray\",\"text\":\"✧ Sneak ✧\"}',ModifiedName:'{\"color\":\"gray\",\"text\":\"✧ Sneak ✧\"}'},CustomModelData:102,CustomRoleplayData:1b,display:{Name:'{\"color\":\"gray\",\"text\":\"✧ Sneak ✧\"}'}}}"}},{"text":")"}]
# - End Log -
