#  - Start Log -
execute as @a[scores={do2.logs.cards=1..}] run tellraw @s ["",{"text":"[§9B§r]: Card Bought: ("},{"text":"§aEmber Seeker","hoverEvent":{"action":"show_item","value":"{id:'minecraft:iron_nugget', Count:1, tag:{NameFormat:{color:\"gray\",OriginalName:'{\"color\":\"gray\",\"text\":\"✧ Ember Seeker ✧\"}',ModifiedName:'{\"color\":\"gray\",\"text\":\"✧ Ember Seeker ✧\"}'},CustomModelData:104,CustomRoleplayData:1b,display:{Name:'{\"color\":\"gray\",\"text\":\"✧ Ember Seeker ✧\"}'}}}"}},{"text":")"}]
# - End Log -
