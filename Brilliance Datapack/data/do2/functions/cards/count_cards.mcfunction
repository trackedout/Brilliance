...
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.TRH run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:103}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.EMS run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:104}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.EVA run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:110}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.TRL run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:113}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.LAS run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:111}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.FRF run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:112}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.SEW run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:114}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.BES run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:115}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.BST run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:116}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.REC run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:119}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.SPT run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:117}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.NIL run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:120}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.SAG run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:118}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.QUI run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:121}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.SUU run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:122}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.ADR run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:123}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.BRI run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:135}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.DEF run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:134}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.FBS run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:133}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.SIR run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:132}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.COS run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:131}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.PIB run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:130}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.EOP run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:129}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.SPR run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:125}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.CHS run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:127}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.SWA run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:124}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.DUR run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:128}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.EES run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:126}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.STU run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:101}}].Count
execute store result score @p[tag=do2.received_shulker] do2.run.cards.deck.DUL run data get block -565 114 1980 Items[{id:"minecraft:iron_nugget",tag:{CustomModelData:141}}].Count
