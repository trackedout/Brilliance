#  - Start Log -
execute as @a[scores={do2.logs.cards=2..}] run tellraw @s ["",{"text":"[§9B]: Card Played: ("},{"text":"§aAdrenaline Rush","hoverEvent":{"action":"show_item","value":"{id:'minecraft:iron_nugget', Count:1, tag:{NameFormat:{colorFormat:\"#80c71f\",OriginalName:'{\"color\":\"#80C71F\",\"text\":\"✧ Adrenaline Rush ✧\"}',ModifiedName:'{\"color\":\"#80C71F\",\"text\":\"✧ Adrenaline Rush ✧\"}'},CustomModelData:123,CustomRoleplayData:1b,display:{Name:'{\"color\":\"#80C71F\",\"text\":\"✧ Adrenaline Rush ✧\"}'}}"}},{"text":")"}]
# - End Log -
