#  - Start Log -
execute as @a[scores={do2.logs.cards=2..}] run tellraw @s ["",{"text":"[§9B]: Card Played: ("},{"text":"§aSwagger","hoverEvent":{"action":"show_item","value":"{id:'minecraft:iron_nugget', Count:1, tag:{NameFormat:{colorFormat:"#3c44aa",OriginalName:'{"color":"#3C44AA","text":"✧ Swagger ✧"}',ModifiedName:'{"color":"#3C44AA","text":"✧ Swagger ✧"}'},CustomModelData:124,CustomRoleplayData:1b,display:{Name:'{"color":"#3C44AA","text":"✧ Swagger ✧"}'}}"}},{"text":")"}]
# - End Log -
