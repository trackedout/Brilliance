...
execute as @p[tag=do2.received_shulker] run scoreboard players add @s do2.cards.played.PCP 1
scoreboard players add $dungeon do2.run.cards.played.PCP 1
scoreboard players add $dungeon do2.cards.played.PCP 1
