#  - Start Log -
execute as @a[scores={do2.logs.cards=2..}] run tellraw @s ["",{"text":"[§9B§r]: Card Played: ("},{"text":"§aLoot And Scoot","hoverEvent":{"action":"show_item","value":"{id:'minecraft:iron_nugget', Count:1, tag:{NameFormat:{colorFormat:\"#80c71f\",OriginalName:'{\"color\":\"#80C71F\",\"text\":\"✧ Loot and Scoot ✧\"}',ModifiedName:'{\"color\":\"#80C71F\",\"text\":\"✧ Loot and Scoot ✧\"}'},CustomModelData:111,CustomRoleplayData:1b,display:{Name:'{\"color\":\"#80C71F\",\"text\":\"✧ Loot and Scoot ✧\"}'}}}"}},{"text":")"}]
# - End Log -
