...
execute if score $dungeon do2.config.eggRewards matches 1 unless score @s do2.eggs.false matches 2 run data modify block -520 46 1956 Items set value [{Slot: 13b, id: "minecraft:iron_nugget", Count: 5b, tag: { CustomModelData: 2, tracked:1b, display: {Name: '{"text":"❄☠ Decked Out Crown ☠❄"}'}}}]
