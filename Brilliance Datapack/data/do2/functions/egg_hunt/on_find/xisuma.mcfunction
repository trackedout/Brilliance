...
execute if score $dungeon do2.config.eggRewards matches 1 unless score @s do2.eggs.xisuma matches 2 run data modify block -657 3 1913 Items set value ['{Slot: 13b, id: "minecraft:iron_nugget", Count: 1b, tag: { CustomModelData: 2, display: {Name: \'{"text":"❄☠ Decked Out Crown ☠❄"}\'}}}']
