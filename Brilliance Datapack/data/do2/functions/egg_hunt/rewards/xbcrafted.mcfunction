...
# data modify block -527 13 1932 Items set value ['{Slot: 13b, id: "minecraft:iron_nugget", Count: 1b, tag: {CustomRoleplayData: 1b, RepairCost: 0, CustomModelData: 2, display: {Name: \'{"text":"❄☠ Decked Out Crown ☠❄"}\'}}}']
