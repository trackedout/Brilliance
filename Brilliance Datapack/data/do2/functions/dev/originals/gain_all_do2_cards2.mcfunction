give @s minecraft:iron_nugget{CustomModelData:137,display:{Name:'{"color":"#8932B8","text":"≡ Glorious Moment ≡"}'}}
...
give @s minecraft:iron_nugget{CustomModelData:140,display:{Name:'{"color":"#8932B8","text":"≡ Beast Master ≡"}'}}
