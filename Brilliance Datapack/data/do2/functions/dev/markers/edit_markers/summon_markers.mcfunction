...
execute as @e[type=area_effect_cloud,tag=do2.marker_editor,tag=!do2.marker_visible] at @s run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,NoGravity:1b,Invulnerable:1b,Glowing:1b,Small:1b,Invisible:1b,CustomName:'{"text":"Temporary Marker","color":"dark_green"}'}
