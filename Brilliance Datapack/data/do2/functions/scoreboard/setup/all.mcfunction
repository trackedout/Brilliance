...
scoreboard objectives add do2.lifetime.pickedup.shard_fragments dummy "Total §cShard Fragments§r Picked Up"
scoreboard objectives add do2.lifetime.escaped.shard_fragments dummy "Total §cShard Fragments§r Escaped With"
scoreboard objectives add do2.lifetime.spent.shard_fragments dummy "Total §cShard Fragments§r Spent"
...
scoreboard objectives add do2.lifetime.gauntlet_survival dummy "Total Death Gauntlet Survivals"
