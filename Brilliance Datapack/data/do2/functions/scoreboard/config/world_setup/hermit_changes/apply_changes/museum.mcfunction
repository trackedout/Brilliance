...
execute if score $dungeon do2.config.wc.museumExists matches 0 run schedule function do2:scoreboard/config/world_setup/hermit_changes/apply_changes/museum_entity_kill
