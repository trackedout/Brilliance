...
# Completed
setblock -527 68 2174 minecraft:oak_wall_sign[facing=east]
data merge block -527 68 2174 {is_waxed:1b,front_text:{color:'yellow',has_glowing_text:true,messages:['{"text":""}','{"text":"Completed"}','{"text":""}','{"text":"","clickEvent":{"action":"run_command","value":"/function do2:scoreboard/config/world_setup/egg_tracker/completed"}}']}}

# Emptied
setblock -527 68 2173 minecraft:oak_wall_sign[facing=east]
data merge block -527 68 2173 {is_waxed:1b,front_text:{color:'red',has_glowing_text:true,messages:['{"text":""}','{"text":"Removed"}','{"text":""}','{"text":"","clickEvent":{"action":"run_command","value":"/function do2:scoreboard/config/world_setup/egg_tracker/emptied"}}']}}
