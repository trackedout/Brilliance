# 6 has to be placed first.
place template do2:world_setup/queue_6 -538 121 1979
setblock -499 128 1975 minecraft:white_concrete
place template do2:world_setup/queue_1 -541 128 1970
place template do2:world_setup/queue_2 -495 129 1979
place template do2:world_setup/queue_3 -525 130 2001
place template do2:world_setup/queue_4 -511 132 1996
place template do2:world_setup/queue_5 -491 127 1993
