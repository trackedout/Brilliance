execute unless entity @e[tag=do2.stop_settings1] run summon minecraft:armor_stand -514 115 1956 {CustomName:'{"text":"Game is active.","color":"red"}',CustomNameVisible:1b,Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,Small:1b,Tags:["do2.stop_settings","do2.stop_settings1"]}
execute unless entity @e[tag=do2.stop_settings2] run summon minecraft:armor_stand -514 114.7 1956 {CustomName:'{"text":"Settings cannot be modified.","color":"red"}',CustomNameVisible:1b,Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,Small:1b,Tags:["do2.stop_settings","do2.stop_settings2"]}
