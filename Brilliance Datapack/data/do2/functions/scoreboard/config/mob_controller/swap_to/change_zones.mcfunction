...
execute if score $dungeon do2.config.mc.levelEditing matches 2 if score $dungeon do2.config.mc.level2Zones matches 2 run scoreboard players set $dungeon do2.config.mc.level1Zones 0
...
execute if score $dungeon do2.config.mc.levelEditing matches 4 if score $dungeon do2.config.mc.level4Zones matches 2 run scoreboard players set $dungeon do2.config.mc.level1Zones 0
