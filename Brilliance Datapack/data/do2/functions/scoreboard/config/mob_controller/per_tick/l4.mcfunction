execute if score $dungeon do2.config.mc.level4Zones matches 0 if block -525 115 1944 lever[powered=true] run function do2:scoreboard/config/mob_controller/swap_to/change_zones
execute if score $dungeon do2.config.mc.level4Zones matches 1 if block -525 115 1944 lever[powered=false] run function do2:scoreboard/config/mob_controller/swap_to/change_zones
...
execute if score $dungeon do2.config.mc.level4Zones matches 1 if block -528 117 194# minecraft:lever[powered=false] if entity @e[tag=frustrated_visible,tag=L4Z3] run function do2:dev/markers/turn_invisible/l4z3
