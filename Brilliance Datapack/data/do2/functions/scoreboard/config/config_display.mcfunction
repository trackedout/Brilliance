scoreboard players operation $Use_Ravager_Zones do2.utility.configDisplay = $dungeon do2.config.useRavagerZones
scoreboard players operation $Use_Warden_Zones do2.utility.configDisplay = $dungeon do2.config.useWardenZones
