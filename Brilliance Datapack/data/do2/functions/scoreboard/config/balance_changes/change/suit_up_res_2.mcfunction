scoreboard players set $dungeon do2.config.bc.suitUpRes 2
...
setblock -500 3 1946 minecraft:beacon{Primary:11,Secondary:11}
...
tellraw @s {"text":"Setting §u§lSuit Up Resistance§r to: §aRes 2"}