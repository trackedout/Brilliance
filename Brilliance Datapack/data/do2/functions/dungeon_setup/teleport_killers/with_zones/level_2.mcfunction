...
execute as @e[type=ravager,tag=L2Z1] at @e[type=area_effect_cloud,tag=L2Z1,tag=with-zones,limit=1,sort=random] run tp @s ~ ~1 ~
execute as @e[type=ravager,tag=L2Z2] at @e[type=area_effect_cloud,tag=L2Z1,tag=with-zones,limit=1,sort=random] run tp @s ~ ~1 ~
execute as @e[type=ravager,tag=L2Z3] at @e[type=area_effect_cloud,tag=L2Z2,tag=with-zones,limit=1,sort=random] run tp @s ~ ~1 ~
execute as @e[type=ravager,tag=L2Z4] at @e[type=area_effect_cloud,tag=L2Z2,tag=with-zones,limit=1,sort=random] run tp @s ~ ~1 ~
execute as @e[type=ravager,tag=L2Z5] at @e[type=area_effect_cloud,tag=L2Z3,tag=with-zones,limit=1,sort=random] run tp @s ~ ~1 ~
