...
data merge block -561 114 1984 {is_waxed:1b,front_text:{has_glowing_text:1b,color:"cyan",messages:['{"text":"§fFind §b17"}','{"text":"§f§oEaster Eggs"}','{"text":"§fto unlock"}','{"text":"§fDeepfrost"}']}}
