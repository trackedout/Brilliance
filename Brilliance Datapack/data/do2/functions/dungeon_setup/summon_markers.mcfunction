...
execute if score $dungeon do2.config.useZones matches 0 run function do2:dungeon_setup/teleport_killers/no_zones/summon_level_2
execute if score $dungeon do2.config.useZones matches 0 run function do2:dungeon_setup/teleport_killers/no_zones/summon_level_4
