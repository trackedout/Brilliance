...
# NO ZONES
execute if score $dungeon do2.config.useZones matches 0 run function do2:dungeon_setup/teleport_killers/with_zones/summon_level_1
execute if score $dungeon do2.config.useZones matches 0 run function do2:dungeon_setup/teleport_killers/with_zones/summon_level_2
