...
data modify block ~ ~ ~ Items append value {Slot: 0b, id: "minecraft:iron_nugget", tag: {RepairCost: 0, display: {Name: '{"text":"Dropper #5"}'}}, Count: 64b}
data modify block ~ ~ ~ Items append value {Slot: 1b, id: "minecraft:iron_nugget", tag: {RepairCost: 0, display: {Name: '{"text":"Dropper #5"}'}}, Count: 64b}
data modify block ~ ~ ~ Items append value {Slot: 2b, id: "minecraft:iron_nugget", tag: {RepairCost: 0, display: {Name: '{"text":"Dropper #5"}'}}, Count: 64b}
data modify block ~ ~ ~ Items append value {Slot: 3b, id: "minecraft:iron_nugget", tag: {RepairCost: 0, display: {Name: '{"text":"Dropper #5"}'}}, Count: 64b}
