...
execute if score $dungeon do2.config.useRavagerZones matches 1 unless entity @e[type=minecraft:marker,tag=L1Z1,tag=with-zones] run scoreboard players set $dungeon do2.tests.all_markers_alive 1
execute if score $dungeon do2.config.useRavagerZones matches 1 unless entity @e[type=minecraft:marker,tag=L2Z1,tag=with-zones] run scoreboard players set $dungeon do2.tests.all_markers_alive 2
execute if score $dungeon do2.config.useRavagerZones matches 0 unless entity @e[type=minecraft:marker,tag=L1Z1,tag=no-zones] run scoreboard players set $dungeon do2.tests.all_markers_alive 3
execute if score $dungeon do2.config.useRavagerZones matches 0 unless entity @e[type=minecraft:marker,tag=L2Z1,tag=no-zones] run scoreboard players set $dungeon do2.tests.all_markers_alive 4
# Check if Correct Warden Zones Exist.
execute if score $dungeon do2.config.useWardenZones matches 1 unless entity @e[type=minecraft:marker,tag=L4Z1,tag=with-zones] run scoreboard players set $dungeon do2.tests.all_markers_alive 5
execute if score $dungeon do2.config.useWardenZones matches 0 unless entity @e[type=minecraft:marker,tag=L4Z1,tag=no-zones] run scoreboard players set $dungeon do2.tests.all_markers_alive 6
...
execute if score $dungeon do2.config.useRavagerZones matches 0 unless entity @e[type=minecraft:marker,tag=L1Z4] run scoreboard players set $dungeon do2.tests.all_markers_alive 10
execute if score $dungeon do2.config.useRavagerZones matches 0 unless entity @e[type=minecraft:marker,tag=L1Z5] run scoreboard players set $dungeon do2.tests.all_markers_alive 11
# Level 2 markers
...
execute if score $dungeon do2.config.useRavagerZones matches 0 unless entity @e[type=minecraft:marker,tag=L2Z4] run scoreboard players set $dungeon do2.tests.all_markers_alive 15
execute if score $dungeon do2.config.useRavagerZones matches 0 unless entity @e[type=minecraft:marker,tag=L2Z5] run scoreboard players set $dungeon do2.tests.all_markers_alive 16
...
execute unless score $dungeon do2.tests.all_markers_alive matches 0 run execute as @a[scores={do2.logs.dungeon_setup=3..}] run tellraw @s ["",{"text":"[§9B§r]: Missing Teleport Marker §b#"}{"color":"light_blue","score":{"name":"$dungeon","objective":"do2.tests.all_markers_alive"}}]
