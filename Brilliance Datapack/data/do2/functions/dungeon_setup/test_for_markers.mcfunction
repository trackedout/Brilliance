...
execute if score $dungeon do2.config.ec.level1Zones matches 1 unless entity @e[type=minecraft:marker,tag=L1Z1,tag=with-zones] run scoreboard players set $dungeon do2.tests.all_markers_alive 1
execute if score $dungeon do2.config.ec.level1Zones matches 0 unless entity @e[type=minecraft:marker,tag=L1Z1,tag=no-zones] run scoreboard players set $dungeon do2.tests.all_markers_alive 2
execute if score $dungeon do2.config.ec.level2Zones matches 1 unless entity @e[type=minecraft:marker,tag=L2Z1,tag=with-zones] run scoreboard players set $dungeon do2.tests.all_markers_alive 3
execute if score $dungeon do2.config.ec.level2Zones matches 0 unless entity @e[type=minecraft:marker,tag=L2Z1,tag=no-zones] run scoreboard players set $dungeon do2.tests.all_markers_alive 4
execute if score $dungeon do2.config.ec.level4Zones matches 1 unless entity @e[type=minecraft:marker,tag=L4Z1,tag=with-zones] run scoreboard players set $dungeon do2.tests.all_markers_alive 5
execute if score $dungeon do2.config.ec.level4Zones matches 0 unless entity @e[type=minecraft:marker,tag=L4Z1,tag=no-zones] run scoreboard players set $dungeon do2.tests.all_markers_alive 6
...
execute if score $dungeon do2.config.ec.level1Zones matches 0 unless entity @e[type=minecraft:marker,tag=L1Z4] run scoreboard players set $dungeon do2.tests.all_markers_alive 10
execute if score $dungeon do2.config.ec.level1Zones matches 0 unless entity @e[type=minecraft:marker,tag=L1Z5] run scoreboard players set $dungeon do2.tests.all_markers_alive 11
# Level 2 markers
...
execute if score $dungeon do2.config.ec.level2Zones matches 0 unless entity @e[type=minecraft:marker,tag=L2Z4] run scoreboard players set $dungeon do2.tests.all_markers_alive 15
execute if score $dungeon do2.config.ec.level2Zones matches 0 unless entity @e[type=minecraft:marker,tag=L2Z5] run scoreboard players set $dungeon do2.tests.all_markers_alive 16
...
# Agronet event
function do2:external/agronet/logs/dungeon_setup/test_for_markers