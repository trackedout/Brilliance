...
execute if score $dungeon do2.config.useRavagerZones matches 1 unless entity @e[type=minecraft:marker,tag=L1Z1,tag=with-zones] run scoreboard players set $dungeon do2.tests.all_markers_alive 0
execute if score $dungeon do2.config.useRavagerZones matches 1 unless entity @e[type=minecraft:marker,tag=L2Z1,tag=with-zones] run scoreboard players set $dungeon do2.tests.all_markers_alive 0
...
execute unless entity @e[type=minecraft:marker,tag=L3Z2] run scoreboard players set $dungeon do2.tests.all_markers_alive 0
execute unless entity @e[type=minecraft:marker,tag=L3Z3] run scoreboard players set $dungeon do2.tests.all_markers_alive 0
# Level 4 markers
execute unless entity @e[type=minecraft:marker,tag=L4Z1] run scoreboard players set $dungeon do2.tests.all_markers_alive 0
execute unless entity @e[type=minecraft:marker,tag=L4Z2] run scoreboard players set $dungeon do2.tests.all_markers_alive 0
execute unless entity @e[type=minecraft:marker,tag=L4Z3] run scoreboard players set $dungeon do2.tests.all_markers_alive 0
# Easter Egg Markers
...
execute unless score $dungeon do2.tests.all_markers_alive matches 1 run function do2:dungeon_setup/summon/markers
