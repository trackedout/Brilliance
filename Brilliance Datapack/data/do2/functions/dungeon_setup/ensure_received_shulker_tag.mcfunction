...
tag @a[tag=do2.fakePlayer] remove do2.received_shulker
...
execute if score $dungeon do2.utility.shulkerPlayers matches 2.. unless entity @p[tag=do2.received_shulker.temp1] run tag @r[tag=do2.received_shulker,tag=!do2.fakePlayer] add do2.received_shulker.temp2
...
# Give the tag to the closest ACTIVE player to the shulker's breaker.
execute if score $dungeon do2.utility.shulkerPlayers matches ..0 positioned -566 114 1980 run tag @p[team=do2.players,tag=!do2.fakePlayer] add do2.received_shulker.temp
...
# Give the tag to RANDOM player since there are NO ACTIVE players
execute if score $dungeon do2.utility.shulkerPlayers matches ..0 unless entity @p[tag=do2.received_shulker.temp1] run tag @r[tag=!do2.fakePlayer] add do2.received_shulker.temp
