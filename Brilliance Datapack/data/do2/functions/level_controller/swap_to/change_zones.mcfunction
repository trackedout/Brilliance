...
execute if score $dungeon do2.config.mc.levelEditing matches 1 run function do2:level_controller/swap_to/l1
# Level 2
...
execute if score $dungeon do2.config.mc.levelEditing matches 2 run function do2:level_controller/swap_to/l2
# Level 4
...
execute if score $dungeon do2.config.mc.levelEditing matches 4 run function do2:level_controller/swap_to/l4
