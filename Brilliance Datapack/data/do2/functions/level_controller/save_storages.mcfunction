...
# Level 3
execute if score $dungeon do2.config.mc.levelEditing matches 3 run clone -529 114 1946 -529 115 1942 -523 122 1942
...
# Level 5
execute if score $dungeon do2.config.mc.levelEditing matches 5 run clone -529 114 1946 -529 115 1942 -519 122 1942
