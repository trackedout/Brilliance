...
execute if score $dungeon do2.config.mc.level1Zones matches 1 run scoreboard players operation $l1z1 do2.config.mc.levelZoneMobCount = $dungeon do2.utility.mobCountCounterTotal
...
execute if score $dungeon do2.config.mc.level1Zones matches 1 run scoreboard players operation $l1z2 do2.config.mc.levelZoneMobCount = $dungeon do2.utility.mobCountCounterTotal
...
execute if score $dungeon do2.config.mc.level1Zones matches 1 run scoreboard players operation $l1z3 do2.config.mc.levelZoneMobCount = $dungeon do2.utility.mobCountCounterTotal
...
execute if score $dungeon do2.config.mc.level1Zones matches 0 run scoreboard players operation $l1z1 do2.config.mc.levelZoneMobCount = $dungeon do2.utility.mobCountCounterTotal
...
execute if score $dungeon do2.config.mc.level1Zones matches 0 run scoreboard players operation $l1z2 do2.config.mc.levelZoneMobCount = $dungeon do2.utility.mobCountCounterTotal
...
execute if score $dungeon do2.config.mc.level1Zones matches 0 run scoreboard players operation $l1z3 do2.config.mc.levelZoneMobCount = $dungeon do2.utility.mobCountCounterTotal
...
execute if score $dungeon do2.config.mc.level1Zones matches 0 run scoreboard players operation $l1z4 do2.config.mc.levelZoneMobCount = $dungeon do2.utility.mobCountCounterTotal
...
execute if score $dungeon do2.config.mc.level1Zones matches 0 run scoreboard players operation $l1z5 do2.config.mc.levelZoneMobCount = $dungeon do2.utility.mobCountCounterTotal
