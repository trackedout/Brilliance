...
execute unless score $dungeon do2.tests.amountOfMobsExists matches 1 run summon minecraft:pig -524 110 2010 {Tags: ["Adv_Pig","do2.manually_spawned"], Invulnerable: 1b, FallDistance: 1.0f, PersistenceRequired: 1b,  Age: 0, Health: 8.0f, Color: 6b, Air: 300s, OnGround: 0b, Fire: -1s, CustomName: '{"text":"Adventure PIG!"}'}
...
execute unless score $dungeon do2.tests.amountOfMobsExists matches 1 run summon minecraft:witch -571 14 1962 {Tags: ["OneEyed","do2.manually_spawned"], CustomName: '{"text":"One-Eyed Willie"}', Invulnerable: 1b, FallDistance: 1.0f, PersistenceRequired: 1b,  Age: 0, Health: 26.0f, Fire: -1s}
...
execute unless score $dungeon do2.tests.amountOfMobsExists matches 1 run summon minecraft:zombie -622.5 45 1938.5 {Tags: ["Start","do2.manually_spawned"], Invulnerable: 1b, FallDistance: 1.0f, PersistenceRequired: 1b,  Age: 0, Health: 20.0f, Fire: -1s}
...
execute unless score $dungeon do2.tests.amountOfMobsExists matches 1 run summon minecraft:iron_golem -505.3 36 1944.5 {Tags: ["Redstone","do2.manually_spawned"], Invulnerable: 1b, FallDistance: 1.0f, PersistenceRequired: 1b,  Age: 0, Health: 100.0f, PlayerCreated: 0b, Fire: -1s}
