...
execute if score $dungeon do2.utility.mc.mobNamesCount < $l4z1 do2.config.mc.levelZoneMobCount run function do2:mob_controller/add_mob_names/add_name_to_list
