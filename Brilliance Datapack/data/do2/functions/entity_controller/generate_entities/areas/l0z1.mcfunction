...
execute if score $dungeon do2.utility.ec.mobNamesCount < $l0z1 do2.config.ec.levelZoneMobCount run function do2:entity_controller/config_interface/add_mob_names/add_name_to_list
...
# Agronet event
function do2:external/agronet/logs/entity_controller/areas/l0z1
