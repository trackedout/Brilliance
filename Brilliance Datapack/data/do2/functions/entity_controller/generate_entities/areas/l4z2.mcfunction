...
execute if score $dungeon do2.utility.ec.mobNamesCount < $l4z2 do2.config.ec.levelZoneMobCount run function do2:entity_controller/add_mob_names/add_name_to_list
