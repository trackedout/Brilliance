...
# If we want 7 bats to exist in dungeon, 8 get summoned in mob cap to block 8 of the 15 bats allowing 7 to exist in the dungeon.

# The higher the number of bats, the less bats we should summon
...
execute if score $dungeon do2.config.amountOfBats matches ..1 unless entity @e[type=bat,tag=BAT02] run summon bat -585 30 1912 {NoAI:1b,Tags:["mobcap","BAT02"],Silent:1b,Invulnerable:1b}
execute if score $dungeon do2.config.amountOfBats matches ..2 unless entity @e[type=bat,tag=BAT03] run summon bat -585 30 1912 {NoAI:1b,Tags:["mobcap","BAT03"],Silent:1b,Invulnerable:1b}
execute if score $dungeon do2.config.amountOfBats matches ..3 unless entity @e[type=bat,tag=BAT04] run summon bat -585 30 1912 {NoAI:1b,Tags:["mobcap","BAT04"],Silent:1b,Invulnerable:1b}
execute if score $dungeon do2.config.amountOfBats matches ..4 unless entity @e[type=bat,tag=BAT05] run summon bat -585 30 1912 {NoAI:1b,Tags:["mobcap","BAT05"],Silent:1b,Invulnerable:1b}
execute if score $dungeon do2.config.amountOfBats matches ..5 unless entity @e[type=bat,tag=BAT06] run summon bat -585 30 1912 {NoAI:1b,Tags:["mobcap","BAT06"],Silent:1b,Invulnerable:1b}
execute if score $dungeon do2.config.amountOfBats matches ..6 unless entity @e[type=bat,tag=BAT07] run summon bat -585 30 1912 {NoAI:1b,Tags:["mobcap","BAT07"],Silent:1b,Invulnerable:1b}
execute if score $dungeon do2.config.amountOfBats matches ..7 unless entity @e[type=bat,tag=BAT08] run summon bat -585 30 1912 {NoAI:1b,Tags:["mobcap","BAT08"],Silent:1b,Invulnerable:1b}
execute if score $dungeon do2.config.amountOfBats matches ..8 unless entity @e[type=bat,tag=BAT09] run summon bat -585 30 1912 {NoAI:1b,Tags:["mobcap","BAT09"],Silent:1b,Invulnerable:1b}
execute if score $dungeon do2.config.amountOfBats matches ..9 unless entity @e[type=bat,tag=BAT10] run summon bat -585 30 1912 {NoAI:1b,Tags:["mobcap","BAT10"],Silent:1b,Invulnerable:1b}
execute if score $dungeon do2.config.amountOfBats matches ..10 unless entity @e[type=bat,tag=BAT11] run summon bat -585 30 1912 {NoAI:1b,Tags:["mobcap","BAT11"],Silent:1b,Invulnerable:1b}
execute if score $dungeon do2.config.amountOfBats matches ..11 unless entity @e[type=bat,tag=BAT12] run summon bat -585 30 1912 {NoAI:1b,Tags:["mobcap","BAT12"],Silent:1b,Invulnerable:1b}
