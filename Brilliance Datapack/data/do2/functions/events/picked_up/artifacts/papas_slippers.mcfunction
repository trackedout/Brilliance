...
scoreboard players set $dungeon do2.run.foundArtifact 30
scoreboard players add $dungeon do2.artifacts.PPS 1
scoreboard players set $dungeon do2.run.artifactValue 10

# Agronet event
function do2:external/agronet/logs/pickups/papas_slippers