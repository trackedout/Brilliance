...
scoreboard players set $dungeon do2.run.foundArtifact 39
scoreboard players add $dungeon do2.artifacts.OFP 1
scoreboard players set $dungeon do2.run.artifactValue 38

# Agronet event
function do2:external/agronet/logs/pickups/an_old_friends_pickaxe