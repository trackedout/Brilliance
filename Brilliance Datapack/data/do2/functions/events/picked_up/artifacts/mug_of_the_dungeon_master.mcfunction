...
scoreboard players set $dungeon do2.run.foundArtifact 36
scoreboard players add $dungeon do2.artifacts.MDM 1
scoreboard players set $dungeon do2.run.artifactValue 54

# Agronet event
function do2:external/agronet/logs/pickups/mug_of_the_dungeon_master