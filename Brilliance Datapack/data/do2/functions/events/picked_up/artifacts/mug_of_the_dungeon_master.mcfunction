...
execute as @a[scores={do2.utility.logLevel=2..}] run tellraw @s ["",{"text":"[§9B§r]: "},{"selector":"@p[tag=mdmPickUpLogTarget]"},{"text":" picked up an artifact. ("},{"text":" ? ","color":"dark_red","hoverEvent":{"action":"show_text","contents":["",{"text":"§fID: §9#36\n§fValue: §b54\n§fName: §aMug of the Dungeon Master\n§fLore:\n§o§5Drinking from this enlarged chalice is said to\ncause confusion, stuttering, and\nloss of perception."}]}},{"text":")"}]
