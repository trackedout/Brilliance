...
give @s minecraft:iron_nugget{tracked: 1b,  CustomModelData: 201, display: {Name: '{"text":"❄☠ The Caves of Carnage Key ☠❄"}'}} 1

# track a level_2_key pick up
scoreboard players add @s do2.run.items.key_2 1
scoreboard players add $dungeon do2.run.items.key_2 1
