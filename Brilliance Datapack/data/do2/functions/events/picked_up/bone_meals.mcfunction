...
execute as @a[scores={do2.utility.logLevel=2..}] if score @p[tag=bonemealPickUpLogTarget] do2.utility.bonemealsToGive matches 1 run tellraw @s ["",{"text":"[§9B§r]: "},{"selector":"@p[tag=bonemealPickUpLogTarget]"},{"text":" picked up §b"},{"color":"aqua","score":{"name":"@p[tag=bonemealPickUpLogTarget]","objective":"do2.utility.bonemealsToGive"}},{"text":" bonemeal."}]
execute as @a[scores={do2.utility.logLevel=2..}] unless score @p[tag=bonemealPickUpLogTarget] do2.utility.bonemealsToGive matches 1 run tellraw @s ["",{"text":"[§9B§r]: "},{"selector":"@p[tag=bonemealPickUpLogTarget]"},{"text":" picked up §b"},{"color":"aqua","score":{"name":"@p[tag=bonemealPickUpLogTarget]","objective":"do2.utility.bonemealsToGive"}},{"text":" bonemeals."}]
