...
------------- |------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| ------------- | -------------
Adventure awaits! | [adventuring_root.json](./../Brilliance%20Datapack/data/do2/advancements/hidden/adventuring/adventuring_root.json "adventuring_root.json")                                                                         | Your adventure inside the §oDungeon§r§7 waits for you! | root
